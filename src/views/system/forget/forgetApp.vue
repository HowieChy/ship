<template>
  <div>
    <header>
      <a @click="back"><svg class="icon" aria-hidden="true"><use xlink:href="#icon-return"></use></svg></a><p>找回密码</p></header>
    <div class="m-login">
      <ul>
      ...
      <p class="g-button" style="margin-top: 2rem"><button @click="go">确定</button></p>
    </div>
